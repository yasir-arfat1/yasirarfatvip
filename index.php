		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-body text-center">
					<h4 class="mb-2"><strong>GUNNU [Modified]</strong></h4>
...
<footer>
  <p>Modified By <a href="https://t.me/GodDrick">@GodDrick</a></p>
</footer>
<script>
...
swalWithBootstrapButtons.fire({
  title: "@Leaked_Scripts", 
  text: "Join Our Telegram Channel For More Such Scripts!",
  icon: 'warning',
...
function RedirectUrl(){    
       window.location.href ="https://t.me/leaked_scripts";
    }
